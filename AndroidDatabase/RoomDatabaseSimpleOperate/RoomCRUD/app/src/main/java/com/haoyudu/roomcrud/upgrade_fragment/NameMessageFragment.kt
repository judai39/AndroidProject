 ...
 * Use the [FillMessageFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NameMessageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_name_message, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        fill_name_btn_confirm.setOnClickListener {
            try {
                Toast.makeText(requireContext(),"修改成功",Toast.LENGTH_SHORT).show()
                StudentDao(requireContext()).updateName(toUpgrade.toString(),fill_name_edit.text.toString())
            }catch (e:Exception){
    ...
    companion object {
         ...
         * @return A new instance of fragment FillMessageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NameMessageFragment().apply {
