...
import com.haoyudu.contentresolvertest.adapter.StudentAdapter
import com.haoyudu.contentresolvertest.entity.Student
import com.haoyudu.contentresolvertest.viewmodel.StudentViewModel
...
class MainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val studentViewModel=ViewModelProvider(this,ViewModelProvider.AndroidViewModelFactory(requireActivity().application)).get(
